...
vout1=0
vout2=1
# vout1=$(echo $tx | jq -r '.vout.[0].n

rawtxhex=$(bitcoin-cli -regtest -named createrawtransaction inputs='''[ { "txid": "'$txid'", "vout": '$vout1' }, { "txid": "'$txid'", "vout": '$vout2' } ]''' outputs='''{ "'$recipient'": '$amount' }''')
